...
import BannerBgImg from "@/assets/images/bannerImg2.jpg";
    ...
    <div className="relative">
      ...
      <div className="max-w-340 mx-auto px-3 text-center space-y-7 py-25 md:py-40 text-white">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-11 md:leading-15 lg:leading-18">
          Share Your Startup Vision and <br />
          <span className="text-[#30B868]">Get Meaningful Community</span>
        </h2>
        <p className="text max-w-200 mx-auto leading-7">
          Post your startup ideas, receive valuable insights through comments
          and discussions, and improve your concepts with feedback from
